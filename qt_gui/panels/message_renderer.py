...
class MessageRenderer:
    ...
    def _render_card(self, title: str, style_key: MessageType, indent_level: int = 1,
        ...
        if content_html:
            ...
            # font-size must be applied directly to <p> because Qt's HTML renderer
            # doesn't respect font-size:inherit from parent div for <p> tags
            # (generated by setMarkdown() for plain text with double newlines)
