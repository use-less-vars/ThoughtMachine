...
class Preset:
    ...
    def to_agent_config(self) -> Dict[str, Any]:
        ...
        config.update({'system_prompt': self.system_prompt, 'model': self.model, 'temperature': self.temperature, 'enabled_tools': self.tools if self.tools else config.get('enabled_tools', [])})
        return config
