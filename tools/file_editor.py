...
class FileEditor(ToolBase):
    ...
    def _execute_write(self) -> str:
        ...
        if self.line_number is None:
            ...
            return f"Successfully modified {self.filename}: {result_msg}"
    
    def _execute_insert(self) -> str:
        ...
        return f"Successfully inserted {len(new_lines)} line(s) before line {line_num} in {self.filename}"
    
    def _execute_append(self) -> str:
        ...
        return f"Successfully appended {lines_added} line(s) to {self.filename}"
    
    def _execute_replace(self) -> str:
        ...
        return f"Successfully replaced {len(replacements)} line(s) in {self.filename}"
    ...
    def _execute_delete(self) -> str:
        ...
        return f"Successfully deleted {len(delete_indices)} line(s) from {self.filename}"