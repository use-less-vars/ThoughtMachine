...
# Measured on branch feat/ci-platform-matrix: 3555 tests collect in total and
# `-m "not docker and not e2e"` selects 3552 of them (3 deselected).
DEFAULT_EXPECTED = 3560
