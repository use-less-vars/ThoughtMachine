...
# Measured on branch feat/ci-platform-matrix: 3575 tests collect in total and
# `-m "not docker and not e2e"` selects 3571 of them (4 deselected).
DEFAULT_EXPECTED = 3571
